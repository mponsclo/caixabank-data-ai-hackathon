# Solution: CaixaBank Data AI Hackathon
...
# Train models
python src/models/train_model.py      # ~3 min, writes predictions_3.json
python src/models/predict_model.py    # ~2 min, writes predictions_4.json
